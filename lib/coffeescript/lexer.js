...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    identifierToken() {
      ...
      if (tag === 'IDENTIFIER' && indexOf.call(RESERVED, id) >= 0 && !inCSXTag) {
  ...
  CSX_IDENTIFIER = RegExp(`^(?![\\d<])(${CSX_IDENTIFIER_PART // Must not start with `<`.
  // JSXNamespacedName
  // JSXMemberExpression
}(?:\\s*:\\s*${CSX_IDENTIFIER_PART}|(?:\\s*\\.\\s*${CSX_IDENTIFIER_PART})+)?)`);
  ...
  CSX_ATTRIBUTE = RegExp(`^(?!\\d)(${CSX_IDENTIFIER_PART // JSXNamespacedName
