...
(function() {
  ...
  grammar = {
    ...
    Operation: [
      ...
      o('Expression LEADING_AND Expression',
      function() {
        return new Op($2.toString(),
      $1,
      $3,
      ...
      o('Expression LEADING_OR Expression',
      function() {
        return new Op($2.toString(),
      $1,
      $3,
